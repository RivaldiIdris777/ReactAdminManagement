...
const routes = [
  ...
  { path: '/products/addproduct', name: 'AddProduct', component: AddProduct },

  { path: '/categories', name: 'Categories', component: AllCategories, exact: true },
  { path: '/categories/allcategories', name: 'All Categories', component: AllCategories },
  { path: '/categories/addcategory', name: 'Add Category', component: AddCategory },
]
